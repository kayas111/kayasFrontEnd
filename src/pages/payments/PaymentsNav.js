...
export function PaymentsNav(){
    ...
    <Link to="/pages/payments/mypayments"><div class="button1"><span class="fa fa-list"></span> My tickets</div></Link>
    <Link to="/pages/payments/createticket"><div class="button1"><span class="fa fa-plus"></span>  Create tickets</div></Link>
 <Link to="/pages/payments/mytickets"><div class="button1"><span class="fa fa-user"></span>  Created tickets</div></Link>
    </div>)
}