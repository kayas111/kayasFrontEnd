...
if(Array.from(description).length<1){
  ...
  let payLoad={description:description,price:price}
   Post('/addProduct',payLoad).then(async (resp)=>{
  ...
  //     "success": true,
  //     "product": {
  //         "_id": "6a7c62175f4b53364b24610f",
  //         "description": "Metallic Hanger",
  //         "price": "15,000",
  //         "__v": 0
  //     }
  // }
...
//     let imageName=`productImage_${responseObject._id}`
//      let imageRef= bucket.child(`productsImages/${imageName}`)
